...
train_info_args = {
    ...
    'model_type': 'chatglm',
    # 预训练模型路径 , 从0训练，则置空
    'model_name_or_path': '/home/fm001/wangyuxuan/models/chatglm-6b',
    'config_name': '/home/fm001/wangyuxuan/models/chatglm-6b',
    'tokenizer_name': '/home/fm001/wangyuxuan/models/chatglm-6b',
    'convert_onnx': False, # 转换onnx模型device
    'do_train': True,
    'train_file':  ['/home/fm001/wangyuxuan/data/loan/alpaca-dialog4_aug_v3.json'],
    'max_epochs': 9, # 12, 18, 20 根据数据量去评估
    'max_steps': -1,
    ...
    'weight_decay': 0,
    'warmup_steps': 0,
    'output_dir': './output_loan_alpaca-dialog4_aug_v3',
    'max_seq_length': 512, # 如果资源充足，推荐长度2048 与官方保持一致
    'max_target_length': 256,  # 预测最大长度, 保留字段
