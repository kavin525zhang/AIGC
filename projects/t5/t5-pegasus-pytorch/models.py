...
from transformers import AutoModelForCausalLM, LlamaTokenizer, AutoModelForSeq2SeqLM, get_linear_schedule_with_warmup
...
class LightModel(pl.LightningModule):
    def __init__(self, args):
        ...
        self.model = model_cls.from_pretrained(self.args.model_path, ignore_mismatched_sizes=True)
